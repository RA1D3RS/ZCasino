...
- Si le numéro gagnant est celui sur lequel le joueur a misé (probabilité de 1/50, plutét faible), 
    le croupier lui remet 3 fois la somme misée. 
- Sinon, le croupier regarde si le numéro misé par le joueur est de la méme couleur que le numéro gagnant
...
while game_on:
    ...
    print("La roulette tourne\n     ...\n       ...\n           et s'arréte sur le numéro", numero_gagnant,"\n")
    ...
    if numero_gagnant == numéro_mise:
        ...
        money += ceil(montant_mise/2) # récupére la moitié de la mise de départ
    else:
